...
#     """
#     Pure splitter + per-chunk classifier adapter, with ordering predicted
#     once from the FULL command via your model's ordering head.
#     """
...
#         ordering = (ord_slots.get("ordering") or self.fallback_ordering)
#         if ordering in (None, "", "unknown"):
#             ordering = self.fallback_ordering
...
# grounding_planner.py
# ---------------------------------------------------------
# Splitter + per-chunk classifier + model ordering + rule override
# ---------------------------------------------------------
import re
from typing import Callable, Dict, List, Tuple, Any
